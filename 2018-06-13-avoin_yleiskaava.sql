...
SET search_path TO pg_catalog,public,yk_yleiskaava,yk_kaavamaaraykset,yk_koodiluettelot,yk_kuvaustekniikka,yk_suunnitteluparametrit,yk_prosessi,yk_mitoitus_varanto,yk_metatiedot,yk_kaavoitus_yhteydet,yk_inspire,yk_geoserver;
-- ddl-end --
...
CREATE TYPE yk_prosessi.linkitys_tyyppi AS
 ENUM ('selma','donna','mml','mil','maakuntien_liitto','tukes','museovirasto','syke','like','luke');
-- ddl-end --
...
-- object: yk_geoserver.yk2017_kantakaupunki_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2017_kantakaupunki_alue CASCADE;
CREATE VIEW yk_geoserver.yk2017_kantakaupunki_alue
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'MULTIPOLYGONZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk2017_kantakaupunki_alue OWNER TO postgres;
-- ddl-end --
...
WHERE
	...
	kaavaobjekti_kaavamaarays_yhteys.id_kaavaobjekti = kaavaobjekti.id AND
	kaavaobjekti_kaavamaarays_yhteys.id_kaavamaarays = kaavamaarays.id AND
	GeometryType(kaavaobjekti.geom) = 'MULTILINESTRINGZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_k1_liikennevaylat_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk2040_yleiskaava_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2040_yleiskaava_alue CASCADE;
CREATE VIEW yk_geoserver.yk2040_yleiskaava_alue
AS 
...
WHERE
	...
	yleismaarays.id_yleiskaava = yleiskaava.id;
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_yleiskaava_alue OWNER TO postgres;
-- ddl-end --
...
WHERE
	...
	kaavaobjekti_kaavamaarays_yhteys.id_kaavaobjekti = kaavaobjekti.id AND
	kaavaobjekti_kaavamaarays_yhteys.id_kaavamaarays = kaavamaarays.id AND
	GeometryType(kaavaobjekti.geom) = 'MULTIPOINTZ';
-- ddl-end --
