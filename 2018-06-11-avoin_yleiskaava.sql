...
CREATE TABLE yk_suunnitteluparametrit.tukes_vyohyke(
	...
	kuvaus varchar,
	yleiskaava uuid,
	id_lahtoaineisto_yleiskaava_yhteys uuid,
...
-- ALTER TABLE yk_prosessi.lahtoaineisto_yleiskaava_yhteys DROP CONSTRAINT IF EXISTS virkistysalue_fk CASCADE;
ALTER TABLE yk_prosessi.lahtoaineisto_yleiskaava_yhteys ADD CONSTRAINT virkistysalue_fk FOREIGN KEY (id_virkistysalue)
...
-- ALTER TABLE yk_prosessi.dokumentti_yleiskaava_yhteys DROP CONSTRAINT IF EXISTS liikennejarjestelma_suunnnitelma_fk CASCADE;
ALTER TABLE yk_prosessi.dokumentti_yleiskaava_yhteys ADD CONSTRAINT liikennejarjestelma_suunnnitelma_fk FOREIGN KEY (id_liikennejarjestelma_suunnnitelma)
REFERENCES yk_kaavoitus_yhteydet.liikennejarjestelma_suunnnitelma (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: liikennejarjestelma_suunnnitelma_fk | type: CONSTRAINT --
-- ALTER TABLE yk_prosessi.lahtoaineisto_yleiskaava_yhteys DROP CONSTRAINT IF EXISTS liikennejarjestelma_suunnnitelma_fk CASCADE;
ALTER TABLE yk_prosessi.lahtoaineisto_yleiskaava_yhteys ADD CONSTRAINT liikennejarjestelma_suunnnitelma_fk FOREIGN KEY (id_liikennejarjestelma_suunnnitelma)
REFERENCES yk_kaavoitus_yhteydet.liikennejarjestelma_suunnnitelma (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
...
-- ALTER TABLE yk_prosessi.dokumentti_yleiskaava_yhteys DROP CONSTRAINT IF EXISTS liittyva_kaava_fk CASCADE;
ALTER TABLE yk_prosessi.dokumentti_yleiskaava_yhteys ADD CONSTRAINT liittyva_kaava_fk FOREIGN KEY (id_liittyva_kaava)
...
-- object: lahtoaineisto_yleiskaava_yhteys_fk | type: CONSTRAINT --
-- ALTER TABLE yk_suunnitteluparametrit.tukes_vyohyke DROP CONSTRAINT IF EXISTS lahtoaineisto_yleiskaava_yhteys_fk CASCADE;
ALTER TABLE yk_suunnitteluparametrit.tukes_vyohyke ADD CONSTRAINT lahtoaineisto_yleiskaava_yhteys_fk FOREIGN KEY (id_lahtoaineisto_yleiskaava_yhteys)
REFERENCES yk_prosessi.lahtoaineisto_yleiskaava_yhteys (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: yk_yleiskaava.kaavaobjekti_teema_yhteys | type: TABLE --
-- DROP TABLE IF EXISTS yk_yleiskaava.kaavaobjekti_teema_yhteys CASCADE;
CREATE TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys(
	id uuid NOT NULL,
	id_kaavaobjekti uuid,
	id_teema uuid,
...
-- ddl-end --
ALTER TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys OWNER TO postgres;
-- ddl-end --

-- object: kaavaobjekti_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys DROP CONSTRAINT IF EXISTS kaavaobjekti_fk CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys ADD CONSTRAINT kaavaobjekti_fk FOREIGN KEY (id_kaavaobjekti)
REFERENCES yk_yleiskaava.kaavaobjekti (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: teema_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys DROP CONSTRAINT IF EXISTS teema_fk CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti_teema_yhteys ADD CONSTRAINT teema_fk FOREIGN KEY (id_teema)
REFERENCES yk_kuvaustekniikka.teema (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
SELECT * FROM
	kaavaobjekti,
	kaavaobjekti_kaavamaarays_yhteys,
	kaavaobjekti,
	kaavaobjekti_teema_yhteys,
	teema
WHERE
	teema = 'yk048_k1' AND
	...
	GeometryType(kaavaobjekti.gegeom) = 'POINTZ';
-- ddl-end --
