...
-- object: yk_kaavapalaute | type: SCHEMA --
-- DROP SCHEMA IF EXISTS yk_kaavapalaute CASCADE;
CREATE SCHEMA yk_kaavapalaute;
-- ddl-end --
ALTER SCHEMA yk_kaavapalaute OWNER TO postgres;
-- ddl-end --

-- object: yk_seuranta_ja_vaikutusten_arviointi | type: SCHEMA --
-- DROP SCHEMA IF EXISTS yk_seuranta_ja_vaikutusten_arviointi CASCADE;
CREATE SCHEMA yk_seuranta_ja_vaikutusten_arviointi;
-- ddl-end --
ALTER SCHEMA yk_seuranta_ja_vaikutusten_arviointi OWNER TO postgres;
-- ddl-end --

SET search_path TO pg_catalog,public,yk_yleiskaava,yk_koodiluettelot,yk_kuvaustekniikka,yk_suunnitteluparametrit,yk_prosessi,yk_mitoitus_varanto,yk_metatiedot,yk_inspire,yk_geoserver,yk_kaavapalaute,yk_seuranta_ja_vaikutusten_arviointi;
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.kansallinen_kaava_tyyppi IS E'http://inspire.ec.europa.eu/codelist/PlanTypeNameValue/PlanTypeNameValue.fi.html';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.kansallinen_kaavatyyppi IS E'Kaavatyypit siten kuin ne määritellään jäsenvaltioissa. Tässä koodiluettelossa hyväksytään mitkä tahansa tiedon tarjoajien määrittelemät arvot.';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.kaavan_taso_tyyppi IS E'http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.kaavan_taso IS E'Kaavan aluehierarkia. http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.aluevaraus_tyyppi IS E'Ks. kaikki arvot: http://inspire.ec.europa.eu/codelist/HILUCSValue/';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.muu_kaavakohde_tyyppi IS E'HSRCL Ks. kaikki arvot: http://inspire.ec.europa.eu/codelist/SupplementaryRegulationValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.yleiskaava.version_alkamispvm IS E'INSPIRE';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.yleiskaava.nro IS E'yleiskaavan numero (esim. yk032)';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.taustakartta IS E'Background Map Value - Information regarding the map that has been used as a background in the definition of a spatial plan, a zoning element or a supplementary regulation. Ks. Background Map Value - http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action;jsessionid=F05001FBEDB4246DD99D7D5C531E28A0?objectDetailId=10571';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.taustakartta.taustakarttapvm IS E'INSPIRE';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.taustakartta.taustakartta_referenssi IS E'INSPIRE';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.taustakartta.rajapinta_uri IS E'Myös INSPIRE';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_prosessi.linkitys_tyyppi IS E'naita voi lisätä lisää tarvittaessa';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN yk_prosessi.lahtoaineisto.lahde IS E'lahde sisältää ihmisen ymmärämän lähde-tiedon ja linkitys_tyyppi ohjelmistolle tarkoitetun vastaavan';
-- ddl-end --
COMMENT ON COLUMN yk_prosessi.lahtoaineisto.linkitys_tyyppi IS E'lahde sisältää ihmisen ymmärämän lähde-tiedon ja linkitys_tyyppi ohjelmistolle tarkoitetun vastaavan';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN yk_koodiluettelot.kansallinen_taydentava_kaavamerkinta_luokka.tunniste IS E'esim. AP, TY-1';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.kaavakohde_luokka IS E'http://inspire.ec.europa.eu/codelist/HILUCSValue/';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.taydentava_kaavamerkinta_luokka IS E'http://inspire.ec.europa.eu/codelist/SupplementaryRegulationValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_metatiedot.metatietokortti IS E'http://www.jhs-suositukset.fi/suomi/jhs158 - Paikkatietoaineistojen ja -palveluiden metatiedot';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN yk_suunnitteluparametrit.suhde_maan_tasoon.taso IS E'maan alla < 0, maantasolla = 0, maan päällä > 0, ei määritelty = null';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.laillinen_sitovuus_tyyppi IS E'http://inspire.ec.europa.eu/codelist/RegulationNatureValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.laillinen_sitovuus IS E'Kaavamääräysten laillinen sitovuus. http://inspire.ec.europa.eu/codelist/RegulationNatureValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TYPE yk_koodiluettelot.prosessin_vaihe_tyyppi IS E'Kaavaprosessin yleispiirteinen vaihe, jossa kaava on. http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.prosessin_vaihe IS E'Kaavaprosessin yleispiirteinen vaihe, jossa kaava on. http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_koodiluettelot.kansallinen_kaavakohde_luokka IS E'YM tekemässä näitä, mutta ei vielä saatavilla';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_inspire.kaavakohteen_olemassaolo IS E'HILUCS Presence - http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10556';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_inspire.kansallisen_kaavakohteen_olemassaolo IS E'HILUCS Presence - http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10556';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.kaavaobjekti_kaavamaarays_yhteys IS E'kaavaobjektilla voi olla useita kaavamääräyksiä ja kaavamääräys voi liittyä useaan kaavaobjektiin';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.yleismaarays IS E'http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/SearchObjectSelection.action?search=Official+Documentation';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.yleismaarays.id IS E'http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/SearchObjectSelection.action?search=Official+Documentation';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.yleismaarays.jarjestys_nro IS E'Ominaisuutta voidaan käyttää järjestämään yleismääräykset käyttöliittymässä haluttuun järjestykseen';
-- ddl-end --
...
CREATE TYPE yk_koodiluettelot.kaavoitusprosessin_tila_tyyppi AS
 ENUM ('kaava_vireilla_ja_valmistelussa','keskeytetty','oas_nahtavilla','luonnos_nahtavilla','ehdotus_nahtavilla','tarkistettu_ehdotus_nahtavilla','hyvaksytty_ehdotus','hyvaksytty_ehdotus_josta_valitettu','voimaan_kuulutettu_osin_tai_kokonaan','kumottu','hyvaksytty_kumottavaksi');
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.kaavaobjekti_viiva IS E'Presence of one or several HILUCS values in an area, indicated either as the percentage covered for each value or as the values listed in their order of importance. http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10556';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.id IS E'Uniikki ID tietokannassa, esim. 0079e638-2bb0-ee48-a15d-e560e3720622. Voidaan QGIS:ssä antaa automaattisesti attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.muokkaaja IS E'Henkilö, joka on luonut merkinnän tähän tauluun tai muokannut sitä';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.voimaantulopvm IS E'INSPIRE:n "Valid From"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.kumoamispvm IS E'INSPIRE:n "Valid To"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.version_alkamispvm IS E'INSPIRE:n "begin Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.version_loppumispvm IS E'INSPIRE:n "end Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.kaavamaaraysotsikko IS E'Viivamaisen kohteen kaavamääräyksen otsikko, esim. "Moottoritie" tai  "ohjeellinen ekologinen yhteys". Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.nro IS E'Voidaan käyttää, jos kaavaobjektille halutaan antaa numero. Käytetty olemassa olevan tietokanta-aineiston tuonnissa avoimen tietokantamallin tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.paikan_nimi IS E'Esim. "Lempääläntie" tai "Loukkaanoja"';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.katuosoite IS E'Osoite, joka voi olla tarpeen määritellä osalle kaavaobjekteja.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.karttamerkinta_teksti IS E'Karttamerkintä, jota voidaan käyttää visualisoinneissa.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.pituus_km IS E'Viivamaisen kohteen pituus, joka päivittyy automaattisesti. Yksikkönä kilometri';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.luokittelu IS E'Vapaavalintainen kohteen luokittelu erilaisiin luokkiin tai tyyppeihin';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.lisatieto IS E'Tarvittava lisätieto kohteesta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.aineisto_lisatieto IS E'Mahdollisia huomioita ja lisätietoja aineistosta. Voidaan käytttää myös tuotaessa olemassa olevaa tietokanta-aineistoa avoimen tietokantamallin mukaiseen tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.kohde_periytyy_muualta IS E'INSPIRE:n "inherited From Other Plans"-kenttä Supplementary regulation-taulusta ja käytetään, jos kaavaobjekti on otettu käyttöön jostakin toisesta kaavasta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_viiva.kansallinen_laillinen_sitovuus IS E'INSPIRE:n "specific Regulation Nature"-kenttä Supplementary regulation-taulusta ja voidaan käyttää, kun Ympäristöministeriö on määritellyt mahdolliset arvot';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.kaavaobjekti_piste IS E'Presence of one or several HILUCS values in an area, indicated either as the percentage covered for each value or as the values listed in their order of importance. http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10556';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.id IS E'Uniikki ID tietokannassa, esim. 0079e638-2bb0-ee48-a15d-e560e3720622. Voidaan QGIS:ssä antaa automaattisesti attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.muokkaaja IS E'Henkilö, joka on luonut merkinnän tähän tauluun tai muokannut sitä';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.voimaantulopvm IS E'INSPIRE:n "Valid From"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.kumoamispvm IS E'INSPIRE:n "Valid To"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.version_alkamispvm IS E'INSPIRE:n "begin Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.version_loppumispvm IS E'INSPIRE:n "end Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.kaavamaaraysotsikko IS E'Pistemäisen kohteen kaavamääräyksen otsikko, esim. "Aluekeskus" tai  "Uusi jätevedenpuhdistamo". Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.nro IS E'Voidaan käyttää, jos kaavaobjektille halutaan antaa numero. Käytetty olemassa olevan tietokanta-aineiston tuonnissa avoimen tietokantamallin tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.paikan_nimi IS E'Esim. "Lakalaivan aluekeskus" tai "Tampereen Sähkölaitos Oy, Naistenlahden voimalaitos"';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.katuosoite IS E'Osoite, joka voi olla tarpeen määritellä osalle kaavaobjekteja.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.karttamerkinta_teksti IS E'Karttamerkintä, jota voidaan käyttää visualisoinneissa.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.luokittelu IS E'Vapaavalintainen kohteen luokittelu erilaisiin luokkiin tai tyyppeihin';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.lisatieto IS E'Tarvittava lisätieto kohteesta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.aineisto_lisatieto IS E'Mahdollisia huomioita ja lisätietoja aineistosta. Voidaan käytttää myös tuotaessa olemassa olevaa tietokanta-aineistoa avoimen tietokantamallin mukaiseen tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.kohde_periytyy_muualta IS E'INSPIRE:n "inherited From Other Plans"-kenttä Supplementary regulation-taulusta ja käytetään, jos kaavaobjekti on otettu käyttöön jostakin toisesta kaavasta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_piste.kansallinen_laillinen_sitovuus IS E'INSPIRE:n "specific Regulation Nature"-kenttä Supplementary regulation-taulusta ja voidaan käyttää, kun Ympäristöministeriö on määritellyt mahdolliset arvot';
-- ddl-end --
...
CREATE TABLE yk_yleiskaava.kaavaobjekti_alue (
	...
	muutos_lisatieto varchar,
	aineisto_lisatieto varchar,
	rakennusoikeus_kem smallint,
	rakennusoikeus_lkm smallint,
	id_yleiskaava uuid,
	id_kansallinen_prosessin_vaihe uuid,
	id_kaavakohteen_olemassaolo uuid,
	id_kansallisen_kaavakohteen_olemassaolo uuid,
...
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.id IS E'Uniikki ID tietokannassa, esim. 0079e638-2bb0-ee48-a15d-e560e3720622. Voidaan QGIS:ssä antaa automaattisesti attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.muokkaaja IS E'Henkilö, joka on luonut merkinnän tähän tauluun tai muokannut sitä';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.voimaantulopvm IS E'INSPIRE:n "Valid From"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.kumoamispvm IS E'INSPIRE:n "Valid To"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.version_alkamispvm IS E'INSPIRE:n "begin Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.version_loppumispvm IS E'INSPIRE:n "end Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.kaavamaaraysotsikko IS E'Aluevarauksen kaavamääräyksen otsikko, esim. käyttötarkoitustyyppi "Asumisen alue" tai erityisominaisuusalue "Natura-alue" tai "Suojavyöhyke". Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.kayttotarkoitus_lyhenne IS E'Käyttötarkoituskoodi, esim. "A" tai "C", joka vastaa kaavamaaraysotsikko-sarakkeen arvoa ja joka ilmaiseen maankäyttötyypin. Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.nro IS E'Voidaan käyttää, jos kaavaobjektille halutaan antaa numero. Käytetty olemassa olevan tietokanta-aineiston tuonnissa avoimen tietokantamallin tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.paikan_nimi IS E'Esim. "Lahdesjärvi-Lakalaiva" tai "Koilliskeskus" tai Vihiojan valuma-alue"';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.katuosoite IS E'Osoite, joka voi olla tarpeen määritellä osalle kaavaobjekteja.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.karttamerkinta_teksti IS E'Karttamerkintä, jota voidaan käyttää visualisoinneissa.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.pinta_ala_ha IS E'Aluevarauksen pinta-ala, joka päivittyy automaattisesti. Yksikkönä hehtaari';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.luokittelu IS E'Vapaavalintainen kohteen luokittelu erilaisiin luokkiin tai tyyppeihin';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.lisatieto IS E'Tarvittava lisätieto kohteesta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue.aineisto_lisatieto IS E'Mahdollisia huomioita ja lisätietoja aineistosta. Voidaan käytttää myös tuotaessa olemassa olevaa tietokanta-aineistoa avoimen tietokantamallin mukaiseen tietokantaan';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.id IS E'Uniikki ID tietokannassa, esim. 0079e638-2bb0-ee48-a15d-e560e3720622. Voidaan QGIS:ssä antaa automaattisesti attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.muokkaaja IS E'Henkilö, joka on luonut merkinnän tähän tauluun tai muokannut sitä';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.voimaantulopvm IS E'INSPIRE:n "Valid From"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.kumoamispvm IS E'INSPIRE:n "Valid To"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.version_alkamispvm IS E'INSPIRE:n "begin Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.version_loppumispvm IS E'INSPIRE:n "end Lifespan Version"-kenttä Zoning element ja Supplementary regulation -tauluissa';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.kaavamaaraysotsikko IS E'Aluevarauksen kaavamääräyksen otsikko, esim. käyttötarkoitustyyppi "Asumisen alue" tai erityisominaisuusalue "Natura-alue" tai "Suojavyöhyke". Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.kayttotarkoitus_lyhenne IS E'Käyttötarkoituskoodi, esim. "A" tai "C", joka vastaa kaavamaaraysotsikko-sarakkeen arvoa ja joka ilmaiseen maankäyttötyypin. Voidaan QGIS:ssä antaa lista vaihtoehdoista attribuuttilomake-toiminnon avulla.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.nro IS E'Voidaan käyttää, jos kaavaobjektille halutaan antaa numero. Käytetty olemassa olevan tietokanta-aineiston tuonnissa avoimen tietokantamallin tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.paikan_nimi IS E'Esim. "Lahdesjärvi-Lakalaiva" tai "Koilliskeskus" tai Vihiojan valuma-alue"';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.katuosoite IS E'Osoite, joka voi olla tarpeen määritellä osalle kaavaobjekteja.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.karttamerkinta_teksti IS E'Karttamerkintä, jota voidaan käyttää visualisoinneissa.';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.pinta_ala_ha IS E'Aluevarauksen pinta-ala, joka päivittyy automaattisesti. Yksikkönä hehtaari';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.luokittelu IS E'Vapaavalintainen kohteen luokittelu erilaisiin luokkiin tai tyyppeihin';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.lisatieto IS E'Tarvittava lisätieto kohteesta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.aineisto_lisatieto IS E'Mahdollisia huomioita ja lisätietoja aineistosta. Voidaan käytttää myös tuotaessa olemassa olevaa tietokanta-aineistoa avoimen tietokantamallin mukaiseen tietokantaan';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.kohde_periytyy_muualta IS E'INSPIRE:n "inherited From Other Plans"-kenttä Supplementary regulation-taulusta ja käytetään, jos kaavaobjekti on otettu käyttöön jostakin toisesta kaavasta';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavaobjekti_alue_taydentava.kansallinen_laillinen_sitovuus IS E'INSPIRE:n "specific Regulation Nature"-kenttä Supplementary regulation-taulusta ja voidaan käyttää, kun Ympäristöministeriö on määritellyt mahdolliset arvot';
-- ddl-end --
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.kaavamaarays IS E'http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/SearchObjectSelection.action?search=Official+Documentation';
-- ddl-end --
COMMENT ON COLUMN yk_yleiskaava.kaavamaarays.id IS E'http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/SearchObjectSelection.action?search=Official+Documentation';
-- ddl-end --
...
-- object: viimeksi_muutettu | type: TRIGGER --
-- DROP TRIGGER IF EXISTS viimeksi_muutettu ON yk_yleiskaava.yleiskaava CASCADE;
CREATE TRIGGER viimeksi_muutettu
	BEFORE INSERT OR UPDATE
...
-- object: yk_kaavapalaute.vastaukset | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.vastaukset CASCADE;
CREATE TABLE yk_kaavapalaute.vastaukset (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	jarjestys_nro smallint,
	mielipiteet varchar,
	mielipiteet_liitetiedosto_nimi varchar,
	etunimi varchar,
	sukunimi varchar,
	sahkoposti varchar,
	katuosoite varchar,
	postinumero varchar,
	edustettu_taho varchar,
	edustettu_taho_nimi varchar,
	nimilista_tiedosto_nimi varchar,
	luontiaika timestamp DEFAULT now(),
	ip_osoite varchar,
	user_agent varchar,
	julkaisulupa boolean,
	id_yleiskaava uuid,
	CONSTRAINT vastaukset_pk PRIMARY KEY (id),
	CONSTRAINT jarjestys_nro_uq UNIQUE (jarjestys_nro)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.vastaukset OWNER TO postgres;
-- ddl-end --

-- object: yleiskaava_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.vastaukset DROP CONSTRAINT IF EXISTS yleiskaava_fk CASCADE;
ALTER TABLE yk_kaavapalaute.vastaukset ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (id_yleiskaava)
REFERENCES yk_yleiskaava.yleiskaava (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_kaavapalaute.pisteet | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.pisteet CASCADE;
CREATE TABLE yk_kaavapalaute.pisteet (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	kommentti varchar,
	mielipiteen_laatu varchar,
	geom geometry(POINT, 3067),
	moderoitu boolean,
	moderoitu_kommentti varchar,
	id_vastaukset uuid,
	jarjestys_nro_vastaukset smallint,
	CONSTRAINT pisteet_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.pisteet OWNER TO postgres;
-- ddl-end --

-- object: yk_kaavapalaute.viivat | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.viivat CASCADE;
CREATE TABLE yk_kaavapalaute.viivat (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	kommentti varchar,
	mielipiteen_laatu varchar,
	...
	jarjestys_nro_vastaukset smallint,
	id_vastaukset uuid,
	CONSTRAINT viivat_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.viivat OWNER TO postgres;
-- ddl-end --

-- object: yk_kaavapalaute.alueet | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.alueet CASCADE;
CREATE TABLE yk_kaavapalaute.alueet (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	kommentti varchar,
	mielipiteen_laatu varchar,
	...
	jarjestys_nro_vastaukset smallint,
	id_vastaukset uuid,
	CONSTRAINT alueet_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.alueet OWNER TO postgres;
-- ddl-end --

-- object: vastaukset_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.pisteet DROP CONSTRAINT IF EXISTS vastaukset_fk CASCADE;
ALTER TABLE yk_kaavapalaute.pisteet ADD CONSTRAINT vastaukset_fk FOREIGN KEY (id_vastaukset)
REFERENCES yk_kaavapalaute.vastaukset (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: vastaukset_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.viivat DROP CONSTRAINT IF EXISTS vastaukset_fk CASCADE;
ALTER TABLE yk_kaavapalaute.viivat ADD CONSTRAINT vastaukset_fk FOREIGN KEY (id_vastaukset)
REFERENCES yk_kaavapalaute.vastaukset (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: vastaukset_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.alueet DROP CONSTRAINT IF EXISTS vastaukset_fk CASCADE;
ALTER TABLE yk_kaavapalaute.alueet ADD CONSTRAINT vastaukset_fk FOREIGN KEY (id_vastaukset)
REFERENCES yk_kaavapalaute.vastaukset (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_mitoitus_varanto.varanto_vireilla | type: TABLE --
-- DROP TABLE IF EXISTS yk_mitoitus_varanto.varanto_vireilla CASCADE;
CREATE TABLE yk_mitoitus_varanto.varanto_vireilla (
	yk_nimi varchar,
	yk_nro varchar,
	diaarinro varchar,
	id varchar NOT NULL,
	...
	CONSTRAINT varanto_vireilla_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_mitoitus_varanto.varanto_vireilla OWNER TO postgres;
-- ddl-end --

-- object: yk_mitoitus_varanto.varanto_hyvaksytty | type: TABLE --
-- DROP TABLE IF EXISTS yk_mitoitus_varanto.varanto_hyvaksytty CASCADE;
CREATE TABLE yk_mitoitus_varanto.varanto_hyvaksytty (
	yk_nimi varchar,
	yk_nro varchar,
	diaarinro varchar,
	id varchar NOT NULL,
	...
	var_muu int4,
	geom geometry(MULTIPOLYGON, 3878),
	CONSTRAINT varanto_vireilla_pk_1 PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_mitoitus_varanto.varanto_hyvaksytty OWNER TO postgres;
-- ddl-end --

-- object: yk_mitoitus_varanto.ilmastotyo_varanto | type: TABLE --
-- DROP TABLE IF EXISTS yk_mitoitus_varanto.ilmastotyo_varanto CASCADE;
CREATE TABLE yk_mitoitus_varanto.ilmastotyo_varanto (
	id serial NOT NULL,
	...
	k_valmisv int4,
	id_kaavaobjekti_alue uuid,
	CONSTRAINT ilmastotyo_varanto_pk PRIMARY KEY (id)

);
-- ddl-end --
COMMENT ON TABLE yk_mitoitus_varanto.ilmastotyo_varanto IS E'Tulevaisuuden yhdyskuntarakenteen ilmastovaikutusten arviointimenetelmän (2019) tulevaissuuskenaariolaskennan vaatima ns. "käyttötarkoitusalue"-taulu.';
-- ddl-end --
ALTER TABLE yk_mitoitus_varanto.ilmastotyo_varanto OWNER TO postgres;
-- ddl-end --

-- object: kaavaobjekti_alue_fk | type: CONSTRAINT --
-- ALTER TABLE yk_mitoitus_varanto.ilmastotyo_varanto DROP CONSTRAINT IF EXISTS kaavaobjekti_alue_fk CASCADE;
ALTER TABLE yk_mitoitus_varanto.ilmastotyo_varanto ADD CONSTRAINT kaavaobjekti_alue_fk FOREIGN KEY (id_kaavaobjekti_alue)
REFERENCES yk_yleiskaava.kaavaobjekti_alue (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_kaavapalaute.kirjanmerkit | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.kirjanmerkit CASCADE;
CREATE TABLE yk_kaavapalaute.kirjanmerkit (
	id uuid NOT NULL,
	kirjanmerkki varchar,
	id_vastaukset uuid,
	CONSTRAINT kirjanmerkit_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.kirjanmerkit OWNER TO postgres;
-- ddl-end --

-- object: vastaukset_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.kirjanmerkit DROP CONSTRAINT IF EXISTS vastaukset_fk CASCADE;
ALTER TABLE yk_kaavapalaute.kirjanmerkit ADD CONSTRAINT vastaukset_fk FOREIGN KEY (id_vastaukset)
REFERENCES yk_kaavapalaute.vastaukset (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_kaavapalaute.karttatasot | type: TABLE --
-- DROP TABLE IF EXISTS yk_kaavapalaute.karttatasot CASCADE;
CREATE TABLE yk_kaavapalaute.karttatasot (
	id uuid NOT NULL,
	oskari_id smallint,
	peittavyys smallint,
	nimi varchar,
	...
	id_viivat uuid,
	id_alueet uuid,
	CONSTRAINT karttatasot_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_kaavapalaute.karttatasot OWNER TO postgres;
-- ddl-end --

-- object: pisteet_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.karttatasot DROP CONSTRAINT IF EXISTS pisteet_fk CASCADE;
ALTER TABLE yk_kaavapalaute.karttatasot ADD CONSTRAINT pisteet_fk FOREIGN KEY (id_pisteet)
REFERENCES yk_kaavapalaute.pisteet (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: viivat_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.karttatasot DROP CONSTRAINT IF EXISTS viivat_fk CASCADE;
ALTER TABLE yk_kaavapalaute.karttatasot ADD CONSTRAINT viivat_fk FOREIGN KEY (id_viivat)
REFERENCES yk_kaavapalaute.viivat (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: alueet_fk | type: CONSTRAINT --
-- ALTER TABLE yk_kaavapalaute.karttatasot DROP CONSTRAINT IF EXISTS alueet_fk CASCADE;
ALTER TABLE yk_kaavapalaute.karttatasot ADD CONSTRAINT alueet_fk FOREIGN KEY (id_alueet)
REFERENCES yk_kaavapalaute.alueet (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko | type: TABLE --
-- DROP TABLE IF EXISTS yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko CASCADE;
CREATE TABLE yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	...
	"4" varchar,
	yht int4,
	toteutumisvuosi smallint,
	id_yleiskaava uuid,
	CONSTRAINT kestava_kaupunkirakenne_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko OWNER TO postgres;
-- ddl-end --

-- object: yleiskaava_fk | type: CONSTRAINT --
-- ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko DROP CONSTRAINT IF EXISTS yleiskaava_fk CASCADE;
ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestava_kaupunkirakenne_ruudukko ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (id_yleiskaava)
REFERENCES yk_yleiskaava.yleiskaava (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke | type: TABLE --
-- DROP TABLE IF EXISTS yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke CASCADE;
CREATE TABLE yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke (
	id uuid NOT NULL DEFAULT uuid_generate_v4(),
	geom geometry(MULTIPOLYGONZ, 3878),
	id_yleiskaava uuid,
	CONSTRAINT kestavan_kasvun_vyohyke_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke OWNER TO postgres;
-- ddl-end --

-- object: yleiskaava_fk | type: CONSTRAINT --
-- ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke DROP CONSTRAINT IF EXISTS yleiskaava_fk CASCADE;
ALTER TABLE yk_seuranta_ja_vaikutusten_arviointi.kestavan_kasvun_vyohyke ADD CONSTRAINT yleiskaava_fk FOREIGN KEY (id_yleiskaava)
REFERENCES yk_yleiskaava.yleiskaava (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
