...
CREATE TYPE yk_koodiluettelot.kansallinen_prosessin_vaihe_tyyppi AS
 ENUM ('1_aloitusvaihe','1_1_suunnitteilla','1_2_vireilla','2_valmisteluvaihe','2_1_luonnos','3_ehdotusvaihe','3_1_ehdotus','3_2_tarkistettu_ehdotus','4_hyvaksymisvaihe','4_1_hyvaksytty','4_2_oikaisukehotus','4_3_valitus','5_voimaantulo','5_1_voimassa','5_2_osittain_voimassa','5_3_lainvoimainen','6_kumoaminen','6_1_kumottu','7_raukeaminen','7_1_rauennut');
-- ddl-end --
...
CREATE TYPE yk_koodiluettelot.kayttotarkoitus_lyhenne_tyyppi AS
 ENUM ('A','A/V','C','C/V','EO','EP','P/T','R','RA','SL','T','TY','V','W','L');
-- ddl-end --
...
CREATE TABLE yk_yleiskaava.kaavaobjekti_alue(
	...
	version_loppumispvm date,
	kaavamaaraysotsikko varchar,
	kayttotarkoitus_lyhenne yk_koodiluettelot.kayttotarkoitus_lyhenne_tyyppi,
...
-- object: viimeksi_muutettu_cp | type: TRIGGER --
-- DROP TRIGGER IF EXISTS viimeksi_muutettu_cp ON yk_yleiskaava.kaavaobjekti_alue_taydentava CASCADE;
CREATE TRIGGER viimeksi_muutettu_cp
	BEFORE UPDATE
