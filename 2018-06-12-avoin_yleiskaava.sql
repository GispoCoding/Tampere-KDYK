...
-- object: kaavatyyppi_fk | type: CONSTRAINT --
-- ALTER TABLE yk_prosessi.liittyva_kaava DROP CONSTRAINT IF EXISTS kaavatyyppi_fk CASCADE;
ALTER TABLE yk_prosessi.liittyva_kaava ADD CONSTRAINT kaavatyyppi_fk FOREIGN KEY (id_kaavatyyppi)
REFERENCES yk_koodiluettelot.kaavatyyppi (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: teema_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.yleismaarays DROP CONSTRAINT IF EXISTS teema_fk CASCADE;
ALTER TABLE yk_yleiskaava.yleismaarays ADD CONSTRAINT teema_fk FOREIGN KEY (id_teema)
REFERENCES yk_kuvaustekniikka.teema (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: yk_geoserver.yk048_k1_kaavamerkinta_piste | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_kaavamerkinta_piste CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_kaavamerkinta_piste
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'POINTZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_kaavamerkinta_piste OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_kaavamerkinta_viiva | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_kaavamerkinta_viiva CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_kaavamerkinta_viiva
AS 
...
WHERE
	...
	kaavaobjekti_kaavamaarays_yhteys.id_kaavaobjekti = kaavaobjekti.id AND
	kaavaobjekti_kaavamaarays_yhteys.id_kaavamaarays = kaavamaarays.id AND
	GeometryType(kaavaobjekti.geom) = 'LINESTRINGZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_kaavamerkinta_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_kaavamerkinta_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_kaavamerkinta_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_kaavamerkinta_alue
AS 
...
WHERE
	...
	kaavaobjekti_kaavamaarays_yhteys.id_kaavaobjekti = kaavaobjekti.id AND
	kaavaobjekti_kaavamaarays_yhteys.id_kaavamaarays = kaavamaarays.id AND
	GeometryType(kaavaobjekti.geom) = 'POLYGONZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_kaavamerkinta_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_yleiskaava_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_yleiskaava_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_yleiskaava_alue
AS 
...
WHERE
	teema = 'yk048_k1' AND
	teema.id = yleismaarays.id_teema AND
	yleismaarays.id_yleiskaava = yleiskaava.id;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_yleiskaava_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_apugeometria_piste | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_apugeometria_piste CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_apugeometria_piste
AS 
...
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_apugeometria_piste OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_apugeometria_viiva | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_apugeometria_viiva CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_apugeometria_viiva
AS 
...
WHERE
	...
	teema.id = apugeometria_piste.id_teema;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_apugeometria_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k1_apugeometria_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k1_apugeometria_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k1_apugeometria_alue
AS 
...
WHERE
	...
	teema.id = apugeometria_piste.id_teema;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k1_apugeometria_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_kaavamerkinta_piste | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_kaavamerkinta_piste CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_kaavamerkinta_piste
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'POINTZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_kaavamerkinta_piste OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_kaavamerkinta_viiva | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_kaavamerkinta_viiva CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_kaavamerkinta_viiva
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'LINESTRINGZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_kaavamerkinta_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_kaavamerkinta_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_kaavamerkinta_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_kaavamerkinta_alue
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'POLYGONZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_kaavamerkinta_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_yleiskaava_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_yleiskaava_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_yleiskaava_alue
AS 
...
WHERE
	...
	yleismaarays.id_yleiskaava = yleiskaava.id;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_yleiskaava_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_apugeometria_piste | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_apugeometria_piste CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_apugeometria_piste
AS 
...
WHERE
	...
	teema.id = apugeometria_piste.id_teema;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_apugeometria_piste OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_apugeometria_viiva | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_apugeometria_viiva CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_apugeometria_viiva
AS 
...
WHERE
	...
	teema.id = apugeometria_piste.id_teema;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_apugeometria_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk048_k2_apugeometria_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk048_k2_apugeometria_alue CASCADE;
CREATE VIEW yk_geoserver.yk048_k2_apugeometria_alue
AS 
...
WHERE
	...
	teema.id = apugeometria_piste.id_teema;
-- ddl-end --
ALTER VIEW yk_geoserver.yk048_k2_apugeometria_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk2040_k1_kaavamerkinta_piste | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2040_k1_kaavamerkinta_piste CASCADE;
CREATE VIEW yk_geoserver.yk2040_k1_kaavamerkinta_piste
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'POINTZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_k1_kaavamerkinta_piste OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk2040_k1_kaavamerkinta_viiva | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2040_k1_kaavamerkinta_viiva CASCADE;
CREATE VIEW yk_geoserver.yk2040_k1_kaavamerkinta_viiva
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'LINESTRINGZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_k1_kaavamerkinta_viiva OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk2040_k1_kaavamerkinta_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2040_k1_kaavamerkinta_alue CASCADE;
CREATE VIEW yk_geoserver.yk2040_k1_kaavamerkinta_alue
AS 
...
WHERE
	...
	GeometryType(kaavaobjekti.geom) = 'POLYGONZ';
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_k1_kaavamerkinta_alue OWNER TO postgres;
-- ddl-end --

-- object: yk_geoserver.yk2040_k1_yleiskaava_alue | type: VIEW --
-- DROP VIEW IF EXISTS yk_geoserver.yk2040_k1_yleiskaava_alue CASCADE;
CREATE VIEW yk_geoserver.yk2040_k1_yleiskaava_alue
AS 
...
WHERE
	...
	yleismaarays.id_yleiskaava = yleiskaava.id;
-- ddl-end --
ALTER VIEW yk_geoserver.yk2040_k1_yleiskaava_alue OWNER TO postgres;
-- ddl-end --
