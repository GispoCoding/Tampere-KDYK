...
SET search_path TO pg_catalog,public,yk_yleiskaava,yk_kaavamaaraykset,yk_koodiluettelot,yk_suunnitteluparametrit,yk_kuvaustekniikka,yk_prosessi,yk_mitoitus_varanto,yk_metatiedot,yk_kaavoitus_yhteydet,yk_inspire;
-- ddl-end --
...
CREATE TABLE yk_yleiskaava.kaavaobjekti(
	...
	id_kayttotakoitus uuid,
	id_kaavaobjekti_luokka uuid,
...
-- object: yk_koodiluettelot.kayttotakoitus | type: TABLE --
-- DROP TABLE IF EXISTS yk_koodiluettelot.kayttotakoitus CASCADE;
CREATE TABLE yk_koodiluettelot.kayttotakoitus(
	id uuid NOT NULL,
	koodi varchar,
	varikoodi smallint,
	CONSTRAINT kayttotakoitus_pk PRIMARY KEY (id)

);
-- ddl-end --
ALTER TABLE yk_koodiluettelot.kayttotakoitus OWNER TO postgres;
-- ddl-end --

-- object: kayttotakoitus_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti DROP CONSTRAINT IF EXISTS kayttotakoitus_fk CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti ADD CONSTRAINT kayttotakoitus_fk FOREIGN KEY (id_kayttotakoitus)
REFERENCES yk_koodiluettelot.kayttotakoitus (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
-- object: yk_koodiluettelot.kaavaobjekti_luokka | type: TABLE --
-- DROP TABLE IF EXISTS yk_koodiluettelot.kaavaobjekti_luokka CASCADE;
CREATE TABLE yk_koodiluettelot.kaavaobjekti_luokka(
	id uuid NOT NULL,
	koodi varchar,
	alkup_taulun_nimi varchar,
	CONSTRAINT kaavaobjekti_luokka_pk PRIMARY KEY (id)

);
-- ddl-end --
COMMENT ON COLUMN yk_koodiluettelot.kaavaobjekti_luokka.alkup_taulun_nimi IS 'tietojen siirtoa&hyödyntämistä varten esim. Tampereen yk2040_19122017- ja yk048_0401_2018-kannoista';
-- ddl-end --
ALTER TABLE yk_koodiluettelot.kaavaobjekti_luokka OWNER TO postgres;
-- ddl-end --

-- object: kaavaobjekti_luokka_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti DROP CONSTRAINT IF EXISTS kaavaobjekti_luokka_fk CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti ADD CONSTRAINT kaavaobjekti_luokka_fk FOREIGN KEY (id_kaavaobjekti_luokka)
REFERENCES yk_koodiluettelot.kaavaobjekti_luokka (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: yk_yleiskaava.kaavaobjekti_lisatiedot | type: TABLE --
-- DROP TABLE IF EXISTS yk_yleiskaava.kaavaobjekti_lisatiedot CASCADE;
CREATE TABLE yk_yleiskaava.kaavaobjekti_lisatiedot(
	id uuid NOT NULL,
	id_kaavaobjekti uuid,
	alue_nimi varchar,
	kohde_nimi varchar,
	katuosoite varchar,
	leveys_liikenne real,
	pituus_km real,
	vaylan_nimi varchar,
	pysakki varchar,
	alue_nro integer,
	kohde_nro integer,
	palvelualue varchar,
	rakennusoikeus varchar,
	lahde varchar,
	laji varchar,
	mj_tyyppi varchar,
	mj_tyypinrakenne varchar,
	ajoitus varchar,
	mj_tunnus integer,
	laitos varchar,
	vyohykeleveys varchar,
	kohde varchar,
	uoman_nimi varchar,
	ymparistot varchar,
	valuma_alue varchar,
	uoman_pituus real,
	purku_paikka varchar,
	saast_syy varchar,
	toimenpiteet varchar,
	saast_kuva varchar,
	lisatiedot varchar,
	selvitystarve varchar,
	yk_tilanne varchar,
	ak_tilanne varchar,
...
-- ddl-end --
COMMENT ON TABLE yk_yleiskaava.kaavaobjekti_lisatiedot IS 'Presence of one or several HILUCS values in an area, indicated either as the percentage covered for each value or as the values listed in their order of importance. http://inspire-regadmin.jrc.ec.europa.eu/dataspecification/ScopeObjectDetail.action?objectDetailId=10556';
-- ddl-end --
ALTER TABLE yk_yleiskaava.kaavaobjekti_lisatiedot OWNER TO postgres;
-- ddl-end --

-- object: kaavaobjekti_fk | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti_lisatiedot DROP CONSTRAINT IF EXISTS kaavaobjekti_fk CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti_lisatiedot ADD CONSTRAINT kaavaobjekti_fk FOREIGN KEY (id_kaavaobjekti)
REFERENCES yk_yleiskaava.kaavaobjekti (id) MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --

-- object: kaavaobjekti_lisatiedot_uq | type: CONSTRAINT --
-- ALTER TABLE yk_yleiskaava.kaavaobjekti_lisatiedot DROP CONSTRAINT IF EXISTS kaavaobjekti_lisatiedot_uq CASCADE;
ALTER TABLE yk_yleiskaava.kaavaobjekti_lisatiedot ADD CONSTRAINT kaavaobjekti_lisatiedot_uq UNIQUE (id_kaavaobjekti);
-- ddl-end --
